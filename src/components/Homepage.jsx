...
function HomePage(props) {
    ...
    return (
            <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20'>
                ...
                <h1 className='font-semibold text-5xl sm:text-6xl md:text-7xl'>Text<span className='text-purple-400 bold'>ify</span></h1>
                ...
                >
                    ...
                    <div className='flex items-center gap-2'>
                        ...
                        (recordingStatus === 'recording' ? 'text-rose-300' : 'text-purple-400')}></i>
                    </div>
                </button>
